...
public abstract class Emitter extends Firework {
	...
	private static double launchAngle = 0;				// radians
	...
	// Calculates and returns an angle randomly generated between (firing angle - 
	// variation) and (firing angle + variation) in radians.
	protected double getRandomLaunchAngle() {
